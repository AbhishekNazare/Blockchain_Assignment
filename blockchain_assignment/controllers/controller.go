...
var client = configs.DB // instance of a database
...
func CreateAccount(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"Account created(Account number)": accountNumber})
}
...
func Deposit(c *gin.Context) {
	...
	filter := bson.M{"account_number": req.AccountNo, "pin": hashPassword(req.Pin)}
	var existingAccount models.Account
	err := client.Database("atm").Collection("accounts").FindOne(context.Background(), filter).Decode(&existingAccount)
	if err != nil {
	...
	c.JSON(http.StatusOK, gin.H{"message": "Money Deposited "})
}
...
func Withdraw(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"message": "Money Withdrawn "})
...
func Transfer(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"message": "Money Transferred "})
}
...
func SetPin(c *gin.Context) {
	...
	filter := bson.M{"account_number": req.AccountNo, "pin": hashPassword(req.OldPin)}
